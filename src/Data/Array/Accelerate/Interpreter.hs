...
module Data.Array.Accelerate.Interpreter () where
--   module Data.Array.Accelerate.Interpreter,
--   UniformScheduleFun
-- ) where
...
-- inputConstraints :: Label Comp -> [Label Comp] -> Constraint InterpretOp
...
-- defaultBounds :: Label Comp -> Bounds InterpretOp
